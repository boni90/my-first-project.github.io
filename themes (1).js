(function() {
    ...
    // 10 вариантов загрузчиков с функциями-генераторами
    var loaderGenerators = {
        // 1. Барсы (существующий)
        bars: function(color) {
            return encodeURIComponent("<svg xmlns=\"http://www.w3.org/2000/svg\" width=\"135\" height=\"140\" fill=\"" + color + "\"><rect width=\"10\" height=\"40\" y=\"100\" rx=\"6\"><animate attributeName=\"height\" begin=\"0s\" calcMode=\"linear\" dur=\"1s\" repeatCount=\"indefinite\" values=\"40;100;40\" keyTimes=\"0;0.5;1\"/><animate attributeName=\"y\" begin=\"0s\" calcMode=\"linear\" dur=\"1s\" repeatCount=\"indefinite\" values=\"100;40;100\" keyTimes=\"0;0.5;1\"/></rect><rect width=\"10\" height=\"40\" x=\"20\" y=\"100\" rx=\"6\"><animate attributeName=\"height\" begin=\"0.2s\" calcMode=\"linear\" dur=\"1s\" repeatCount=\"indefinite\" values=\"40;100;40\" keyTimes=\"0;0.5;1\"/><animate attributeName=\"y\" begin=\"0.2s\" calcMode=\"linear\" dur=\"1s\" repeatCount=\"indefinite\" values=\"100;40;100\" keyTimes=\"0;0.5;1\"/></rect><rect width=\"10\" height=\"40\" x=\"40\" y=\"100\" rx=\"6\"><animate attributeName=\"height\" begin=\"0.4s\" calcMode=\"linear\" dur=\"1s\" repeatCount=\"indefinite\" values=\"40;100;40\" keyTimes=\"0;0.5;1\"/><animate attributeName=\"y\" begin=\"0.4s\" calcMode=\"linear\" dur=\"1s\" repeatCount=\"indefinite\" values=\"100;40;100\" keyTimes=\"0;0.5;1\"/></rect><rect width=\"10\" height=\"40\" x=\"60\" y=\"100\" rx=\"6\"><animate attributeName=\"height\" begin=\"0.6s\" calcMode=\"linear\" dur=\"1s\" repeatCount=\"indefinite\" values=\"40;100;40\" keyTimes=\"0;0.5;1\"/><animate attributeName=\"y\" begin=\"0.6s\" calcMode=\"linear\" dur=\"1s\" repeatCount=\"indefinite\" values=\"100;40;100\" keyTimes=\"0;0.5;1\"/></rect><rect width=\"10\" height=\"40\" x=\"80\" y=\"100\" rx=\"6\"><animate attributeName=\"height\" begin=\"0.8s\" calcMode=\"linear\" dur=\"1s\" repeatCount=\"indefinite\" values=\"40;100;40\" keyTimes=\"0;0.5;1\"/><animate attributeName=\"y\" begin=\"0.8s\" calcMode=\"linear\" dur=\"1s\" repeatCount=\"indefinite\" values=\"100;40;100\" keyTimes=\"0;0.5;1\"/></rect><rect width=\"10\" height=\"40\" x=\"100\" y=\"100\" rx=\"6\"><animate attributeName=\"height\" begin=\"1s\" calcMode=\"linear\" dur=\"1s\" repeatCount=\"indefinite\" values=\"40;100;40\" keyTimes=\"0;0.5;1\"/><animate attributeName=\"y\" begin=\"1s\" calcMode=\"linear\" dur=\"1s\" repeatCount=\"indefinite\" values=\"100;40;100\" keyTimes=\"0;0.5;1\"/></rect><rect width=\"10\" height=\"40\" x=\"120\" y=\"100\" rx=\"6\"><animate attributeName=\"height\" begin=\"1.2s\" calcMode=\"linear\" dur=\"1s\" repeatCount=\"indefinite\" values=\"40;100;40\" keyTimes=\"0;0.5;1\"/><animate attributeName=\"y\" begin=\"1.2s\" calcMode=\"linear\" dur=\"1s\" repeatCount=\"indefinite\" values=\"100;40;100\" keyTimes=\"0;0.5;1\"/></rect></svg>");
        },
        
        // 2. Точки
        dots: function(color) {
            return encodeURIComponent("<svg xmlns=\"http://www.w3.org/2000/svg\" width=\"140\" height=\"140\" viewBox=\"0 0 100 100\"><circle cx=\"20\" cy=\"50\" r=\"8\" fill=\"" + color + "\"><animate attributeName=\"cy\" dur=\"1s\" repeatCount=\"indefinite\" values=\"50;30;50\" keyTimes=\"0;0.5;1\"/></circle><circle cx=\"50\" cy=\"50\" r=\"8\" fill=\"" + color + "\"><animate attributeName=\"cy\" dur=\"1s\" repeatCount=\"indefinite\" values=\"50;30;50\" keyTimes=\"0;0.5;1\" begin=\"0.2s\"/></circle><circle cx=\"80\" cy=\"50\" r=\"8\" fill=\"" + color + "\"><animate attributeName=\"cy\" dur=\"1s\" repeatCount=\"indefinite\" values=\"50;30;50\" keyTimes=\"0;0.5;1\" begin=\"0.4s\"/></circle></svg>");
        },
        
        // 3. Спиннер
        spinner: function(color) {
            return encodeURIComponent("<svg xmlns=\"http://www.w3.org/2000/svg\" width=\"140\" height=\"140\" viewBox=\"0 0 100 100\"><circle cx=\"50\" cy=\"50\" r=\"40\" stroke=\"" + color + "\" stroke-width=\"8\" fill=\"none\" stroke-linecap=\"round\"><animate attributeName=\"stroke-dasharray\" dur=\"1.5s\" repeatCount=\"indefinite\" values=\"0 250;150 250;0 250\"/><animateTransform attributeName=\"transform\" type=\"rotate\" from=\"0 50 50\" to=\"360 50 50\" dur=\"1.5s\" repeatCount=\"indefinite\"/></circle></svg>");
        },
        
        // 4. Круг (пульсирующий)
        circle: function(color) {
            return encodeURIComponent("<svg xmlns=\"http://www.w3.org/2000/svg\" width=\"140\" height=\"140\" viewBox=\"0 0 100 100\"><circle cx=\"50\" cy=\"50\" r=\"30\" fill=\"" + color + "\" opacity=\"0.6\"><animate attributeName=\"r\" dur=\"1.5s\" repeatCount=\"indefinite\" values=\"30;40;30\" keyTimes=\"0;0.5;1\"/><animate attributeName=\"opacity\" dur=\"1.5s\" repeatCount=\"indefinite\" values=\"0.6;0.8;0.6\" keyTimes=\"0;0.5;1\"/></circle></svg>");
        },
        
        // 5. Пульс
        pulse: function(color) {
            return encodeURIComponent("<svg xmlns=\"http://www.w3.org/2000/svg\" width=\"140\" height=\"140\" viewBox=\"0 0 100 100\"><circle cx=\"50\" cy=\"50\" r=\"0\" fill=\"none\" stroke=\"" + color + "\" stroke-width=\"4\"><animate attributeName=\"r\" dur=\"1.5s\" repeatCount=\"indefinite\" values=\"0;30;0\"/><animate attributeName=\"opacity\" dur=\"1.5s\" repeatCount=\"indefinite\" values=\"1;0;1\" keyTimes=\"0;0.5;1\"/></circle><circle cx=\"50\" cy=\"50\" r=\"0\" fill=\"none\" stroke=\"" + color + "\" stroke-width=\"4\"><animate attributeName=\"r\" dur=\"1.5s\" repeatCount=\"indefinite\" values=\"0;30;0\" begin=\"0.5s\"/><animate attributeName=\"opacity\" dur=\"1.5s\" repeatCount=\"indefinite\" values=\"1;0;1\" keyTimes=\"0;0.5;1\" begin=\"0.5s\"/></circle></svg>");
        },
        
        // 6. Прыгающие точки
        bouncing: function(color) {
            return encodeURIComponent("<svg xmlns=\"http://www.w3.org/2000/svg\" width=\"140\" height=\"140\" viewBox=\"0 0 100 100\"><circle cx=\"25\" cy=\"50\" r=\"10\" fill=\"" + color + "\"><animate attributeName=\"cy\" dur=\"0.6s\" repeatCount=\"indefinite\" values=\"50;30;50\" keyTimes=\"0;0.5;1\" calcMode=\"spline\" keySplines=\"0.42,0,0.58,1;0.42,0,0.58,1\"/></circle><circle cx=\"50\" cy=\"50\" r=\"10\" fill=\"" + color + "\"><animate attributeName=\"cy\" dur=\"0.6s\" repeatCount=\"indefinite\" values=\"50;30;50\" keyTimes=\"0;0.5;1\" calcMode=\"spline\" keySplines=\"0.42,0,0.58,1;0.42,0,0.58,1\" begin=\"0.1s\"/></circle><circle cx=\"75\" cy=\"50\" r=\"10\" fill=\"" + color + "\"><animate attributeName=\"cy\" dur=\"0.6s\" repeatCount=\"indefinite\" values=\"50;30;50\" keyTimes=\"0;0.5;1\" calcMode=\"spline\" keySplines=\"0.42,0,0.58,1;0.42,0,0.58,1\" begin=\"0.2s\"/></circle></svg>");
        },
        
        // 7. Волна
        wave: function(color) {
            return encodeURIComponent("<svg xmlns=\"http://www.w3.org/2000/svg\" width=\"140\" height=\"140\" viewBox=\"0 0 100 100\"><path d=\"M10,50 Q25,30 40,50 T70,50 T100,50\" fill=\"none\" stroke=\"" + color + "\" stroke-width=\"6\"><animate attributeName=\"d\" dur=\"1.5s\" repeatCount=\"indefinite\" values=\"M10,50 Q25,30 40,50 T70,50 T100,50;M10,50 Q25,70 40,50 T70,50 T100,50;M10,50 Q25,30 40,50 T70,50 T100,50\"/></path></svg>");
        },
        
        // 8. Часы
        clock: function(color) {
            return encodeURIComponent("<svg xmlns=\"http://www.w3.org/2000/svg\" width=\"140\" height=\"140\" viewBox=\"0 0 100 100\"><circle cx=\"50\" cy=\"50\" r=\"40\" fill=\"none\" stroke=\"" + color + "\" stroke-width=\"4\"/><line x1=\"50\" y1=\"50\" x2=\"50\" y2=\"30\" stroke=\"" + color + "\" stroke-width=\"4\" stroke-linecap=\"round\"><animateTransform attributeName=\"transform\" type=\"rotate\" from=\"0 50 50\" to=\"360 50 50\" dur=\"2s\" repeatCount=\"indefinite\"/></line><line x1=\"50\" y1=\"50\" x2=\"70\" y2=\"50\" stroke=\"" + color + "\" stroke-width=\"3\" stroke-linecap=\"round\"><animateTransform attributeName=\"transform\" type=\"rotate\" from=\"0 50 50\" to=\"360 50 50\" dur=\"15s\" repeatCount=\"indefinite\"/></line></svg>");
        },
        
        // 9. Орбита
        orbit: function(color) {
            return encodeURIComponent("<svg xmlns=\"http://www.w3.org/2000/svg\" width=\"140\" height=\"140\" viewBox=\"0 0 100 100\"><circle cx=\"50\" cy=\"50\" r=\"35\" fill=\"none\" stroke=\"" + color + "\" stroke-width=\"2\" opacity=\"0.3\"/><circle cx=\"15\" cy=\"50\" r=\"8\" fill=\"" + color + "\"><animateTransform attributeName=\"transform\" type=\"rotate\" from=\"0 50 50\" to=\"360 50 50\" dur=\"1.5s\" repeatCount=\"indefinite\"/></circle><circle cx=\"85\" cy=\"50\" r=\"5\" fill=\"" + color + "\"><animateTransform attributeName=\"transform\" type=\"rotate\" from=\"360 50 50\" to=\"0 50 50\" dur=\"2s\" repeatCount=\"indefinite\"/></circle></svg>");
        },
        
        // 10. Радуга (многоцветный, использует основной цвет как базовый)
        rainbow: function(color) {
            // Генерация оттенков на основе основного цвета
            var color1 = color;
            var color2 = color.replace(/[0-9a-f]{2}$/i, 'aa'); // Слегка измененный оттенок
            var color3 = color.replace(/[0-9a-f]{2}$/i, '66'); // Еще более светлый
            
            return encodeURIComponent("<svg xmlns=\"http://www.w3.org/2000/svg\" width=\"140\" height=\"140\" viewBox=\"0 0 100 100\"><path d=\"M20,50 A30,30 0 1,1 80,50\" fill=\"none\" stroke=\"" + color1 + "\" stroke-width=\"6\" stroke-dasharray=\"188\" stroke-dashoffset=\"188\"><animate attributeName=\"stroke-dashoffset\" dur=\"1.5s\" repeatCount=\"indefinite\" values=\"188;0;188\"/></path><path d=\"M20,50 A30,30 0 1,0 80,50\" fill=\"none\" stroke=\"" + color2 + "\" stroke-width=\"6\" stroke-dasharray=\"188\" stroke-dashoffset=\"188\"><animate attributeName=\"stroke-dashoffset\" dur=\"1.5s\" repeatCount=\"indefinite\" values=\"188;0;188\" begin=\"0.3s\"/></path><circle cx=\"50\" cy=\"50\" r=\"15\" fill=\"none\" stroke=\"" + color3 + "\" stroke-width=\"4\" stroke-dasharray=\"94\" stroke-dashoffset=\"94\"><animate attributeName=\"stroke-dashoffset\" dur=\"1.5s\" repeatCount=\"indefinite\" values=\"94;0;94\" begin=\"0.6s\"/></circle></svg>");
        }
    };
    ...
    // Функция для применения тем и загрузчика
    function applyTheme(theme, forceReload) {
        ...
        var loaderType = localStorage.getItem('maxsm_themes_loader') || 'bars';
        
        // Получаем SVG загрузчика
        var svgCode = loaderGenerators[loaderType] ? loaderGenerators[loaderType](color) : loaderGenerators['bars'](color);
    ...
    // Функция для применения только загрузчика (без перезагрузки темы)
    function applyLoader() {
        var currentTheme = maxsm_themes.settings.theme;
        if (currentTheme && currentTheme !== 'default') {
            // Удаляем старые стили
            $('#maxsm_themes_theme').remove();
            // Применяем тему с новым загрузчиком
    ...
    // Убрал функцию removeAdditionalSettings - она была причиной дублирования
    ...
    function startPlugin() {
        ...
        if (!localStorage.getItem('maxsm_themes_loader')) {
            localStorage.setItem('maxsm_themes_loader', 'bars');
        }
        ...
        // Добавляем параметры ТОЛЬКО ОДИН РАЗ
        ...
        Lampa.SettingsApi.addParam({
            component: 'maxsm_themes',
            param: {
                name: 'maxsm_themes_loader',
                type: 'select',
                values: {
                    'bars': 'Барсы (вертикальные)',
                    'dots': 'Точки (прыгающие)', 
                    'spinner': 'Спиннер',
                    'circle': 'Пульсирующий круг',
                    'pulse': 'Волновой пульс',
                    'bouncing': 'Прыгающие шары',
                    'wave': 'Волна',
                    'clock': 'Часы',
                    'orbit': 'Орбита',
                    'rainbow': 'Радуга'
                },
                "default": 'Барсы (вертикальные)'
            },
            field: {
                name: Lampa.Lang.translate('maxsm_themes_loader'),
                description: ''
            },
            onChange: function(value) {
                // Применяем только загрузчик
                applyLoader();
            }
        });
